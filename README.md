...
![image](https://user-images.githubusercontent.com/61326119/227205171-5af64814-8eca-4212-b373-2bf7bd0090b0.png)

### リザルト自動保存機能の注意点
今後仕様が変わる可能性があります。

ライバル欄のある座標の画素値を見てリザルト画面かどうかを判定しているため、  
Double Battle系オプションでは自動保存が動きません。  

また、DJ Levelやスコアの更新時に保存する設定では、  
